...
@section('content')
    ...
    <section class="border-b border-slate-100 bg-white pt-36 pb-20 text-center">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h1 class="mb-6 text-5xl font-extrabold tracking-normal text-dark md:text-6xl lg:text-7xl">{{ $heroSec?->heading ?? 'Our Best' }} <span class="text-cyan">Work</span></h1>
    ...
    <section class="bg-light py-24">
        <div class="mx-auto max-w-7xl space-y-20 px-4 sm:px-6 lg:px-8">
            @include('partials.section-heading', ['kicker' => 'Featured', 'title' => 'Case Studies'])
