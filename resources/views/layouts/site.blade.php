...
<body class="bg-white font-sans text-slate-800 antialiased">
    ...
    @if (!empty($ct['whatsapp_number']))
        ...
        <a href="https://wa.me/{{ $waNumber }}?text={{ $waMessage }}"
           ...
           class="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 rounded-full bg-[#25D366] px-5 py-3.5 shadow-lg shadow-green-500/30 transition hover:scale-105 hover:shadow-xl hover:shadow-green-500/40">
            <svg class="h-6 w-6 shrink-0 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <span class="text-sm font-bold text-white whitespace-nowrap">Order on WhatsApp</span>
        </a>
    @endif
</body>
</html>
