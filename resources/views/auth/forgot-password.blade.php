...
<title>Reset Password | Tej Printbrands</title>
  ...
  <div class="flex-1 flex flex-col">
    ...
    <div class="flex-1 flex items-center justify-center p-6 sm:p-12">
      <div class="w-full max-w-md">
        ...
        <div class="w-16 h-16 rounded-2xl flex items-center justify-center mb-6" style="background:#FFF7ED;">
          <svg class="w-8 h-8" fill="none" stroke="#F97316" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"/></svg>
        </div>
        <div class="mb-8">
          <h2 class="text-3xl font-bold mb-2" style="color:#1F2937;">Reset your password</h2>
          <p style="color:#6B7280;">Enter your email and we'll send you a link to reset your password.</p>
        </div>
        @if (session('status'))
        ...
        <form class="space-y-5" method="POST" action="{{ route('password.email') }}">
          ...
          <div class="space-y-2">
            ...
            <p class="text-xs" style="color:#6B7280;">We'll send a recovery link to this email if it matches an account.</p>
          </div>
        ...
        <p class="text-center mt-8 text-sm" style="color:#6B7280;">
          ...
          <a href="{{ route('login') }}" class="font-semibold transition-colors" style="color:#00BCD4;" onmouseover="this.style.color='#006064'" onmouseout="this.style.color='#00BCD4'">Sign in</a>
        </p>
      </div>
    </div>
  </div>
