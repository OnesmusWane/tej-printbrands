...
const navGroups = [
  ...
  },
  {
    section: 'Business',
    items: [
      { label: 'Daily Sales & Expenses', path: '/daily-ledger', perm: 'daily_ledger.view', icon: 'M9 8h6m-6 4h6m-6 4h4M5 21h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2z' },
      ...
      { label: 'Orders',           path: '/orders',           perm: 'orders.view',           icon: 'M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z' },
      { label: 'Projects',         path: '/projects',         perm: 'tasks.view',            icon: 'M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z' },
    ],
  },
  {
    section: 'Content',
    items: [
      ...
      { label: 'Blog',           path: '/blog',           perm: 'content.view',  icon: 'M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z' },
    ],
  },
  {
    section: 'System',
